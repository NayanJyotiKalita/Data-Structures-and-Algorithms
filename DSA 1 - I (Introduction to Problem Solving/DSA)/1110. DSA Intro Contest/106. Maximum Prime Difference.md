...
## Problem Description
In a kingdom, a mathematician named Arya was given an Array of integers, A of size N. The king challenged her to find the maximum distance between the indices of any two (not necessarily different) prime numbers in the array. If there is no prime number in the given array, return -1. </br>
