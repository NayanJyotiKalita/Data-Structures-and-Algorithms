...
Scooby calls a positive integer special if it is divisible by B and it is divisible by C. You need to tell the number of special integers less than or equal to A. </br>
...
### Input Format
First argument is a positive integer A </br>
Second argument is a positive integer B </br>
