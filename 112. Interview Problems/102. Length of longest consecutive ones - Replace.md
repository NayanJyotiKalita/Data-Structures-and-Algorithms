...
## Problem Description
Given a binary string A. It is allowed to do at most one replacement of 0 by 1. Find and return the length of the longest consecutive 1’s that can be achieved. </br>
'or' </br>
